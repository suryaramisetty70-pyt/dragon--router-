# Dokumentasi Server MCP Dragon Router (Bahasa Indonesia)
...
Dragon Router MCP sudah tersedia secara bawaan. Jalankan dengan:
...
| `dragonrouter_test_combo`             | Uji langsung semua model dalam combo melalui permintaan upstream nyata |
| `dragonrouter_get_provider_metrics`   | Metrik terperinci untuk satu penyedia                                  |
| `dragonrouter_best_combo_for_task`    | Rekomendasi kesesuaian tugas beserta alternatifnya                     |
| `dragonrouter_explain_route`          | Jelaskan keputusan routing yang lalu                                   |
| `dragonrouter_get_session_snapshot`   | Status sesi lengkap: biaya, token, kesalahan                           |
