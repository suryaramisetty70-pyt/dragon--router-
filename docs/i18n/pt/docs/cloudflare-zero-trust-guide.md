...
Este guia documenta o padrão ouro de infraestrutura de rede para proteger o **Dragon Router** e expor sua aplicação de forma segura para a internet, **sem abrir nenhuma porta (Zero Inbound)**.

## O que foi feito na sua VM?

Nós ativamos o Dragon Router em modo **Split-Port** através do PM2:
...
3. Clique em **Add a Tunnel**, escolha **Cloudflared** e dê o nome \`Dragon Router-VM\`.
...
- **Subdomain:** \`dragonrouter\` ou \`painel\`
...
3. Em **Application name**, coloque \`Painel Dragon Router\`.
4. Em **Application domain**, coloque \`dragonrouter.seuglobal.com.br\` (O mesmo que você fez na "Rota 2").
5. Clique em **Next**.
...
4. **Name:** \`Anti-Abuso Dragon Router API\`
...
2. O Dragon Router só conversa HTTPS saindo (\`cloudflared\`) e não recebendo TCP direto do mundo.
