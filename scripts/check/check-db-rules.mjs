...
// Estas rotas NÃO consultam o DB do Dragon Router (getDbInstance) — elas abrem o
// SQLite de OUTRO aplicativo (Cursor / Kiro) para auto-importar credenciais.
// Por isso NÃO podem viver em src/lib/db/ (que é o domínio do DB do Dragon Router):
...
// QUALQUER novo SQL cru contra o DB do Dragon Router em rotas/handlers.
