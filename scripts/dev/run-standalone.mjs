...
// #2939: honor DRAGONROUTER_MEMORY_MB (default 512), the same knob
// `dragonrouter serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.DRAGONROUTER_MEMORY_MB);
