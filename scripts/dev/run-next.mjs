...
import { createDragonrouterWsBridge } from "./v1-ws-bridge.mjs";
...
// build default in build-next-isolated.mjs); DRAGONROUTER_USE_TURBOPACK=0 is the
// webpack escape hatch.
const useTurbopack = dev && mergedEnv.DRAGONROUTER_USE_TURBOPACK !== "0";
...
async function start() {
  ...
  const wsBridge = createDragonrouterWsBridge({
    baseUrl: `http://127.0.0.1:${dashboardPort}`,
  });
