...
description: Synchronise Dragon Router configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.
---
...
Authenticates with the Dragon Router cloud worker for remote access.
