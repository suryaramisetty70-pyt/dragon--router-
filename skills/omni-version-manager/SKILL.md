...
When enabled, 9Router starts automatically on the next Dragon Router boot. **LOCAL_ONLY** — loopback only.
...
When enabled, CLIProxyAPI starts automatically on the next Dragon Router boot. **LOCAL_ONLY** — loopback only.
...
When enabled, Mux starts automatically on the next Dragon Router boot. **LOCAL_ONLY** — loopback only.
...
When enabled, Bifrost starts automatically on the next Dragon Router boot. **LOCAL_ONLY** — loopback only.
