...
export const webRuntimeEnvSchema = z.object({
  ...
  DRAGON_ROUTER_DISABLE_BACKGROUND_SERVICES: optionalBooleanEnv,
  CLOUD_URL: optionalHttpUrl,
  NEXT_PUBLIC_CLOUD_URL: optionalHttpUrl,
  DRAGON_ROUTER_PUBLIC_BASE_URL: optionalHttpUrl,
  DRAGON_ROUTER_BASE_URL: optionalHttpUrl,
  BASE_URL: optionalHttpUrl,
  NEXT_PUBLIC_BASE_URL: optionalHttpUrl,
  DRAGON_ROUTER_PORT: optionalPortEnv,
