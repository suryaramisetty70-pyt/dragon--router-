...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-dragon-router-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-dragon-router-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-dragon-router-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-dragon-router-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-dragon-router-auth-scopes";
 ...
 * token matches this process's DRAGON_ROUTER_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-dragon-router-peer-ip";
 ...
 * proxy hop (e.g. Dragon Router behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-dragon-router-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-dragon-router-peer-locality";
