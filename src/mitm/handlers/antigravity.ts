 ...
 * `thinkingConfig`, …). The Dragon Router router endpoint `/v1/chat/completions`
 ...
 *   - forward to `/v1/chat/completions` on the Dragon Router router,
 ...
 * @param model      resolved Dragon Router model string
