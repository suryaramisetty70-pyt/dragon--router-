 ...
 *
 * Serves the Dragon Router A2A Agent Card for discovery by other agents.
...
const BASE_URL = process.env.DRAGON_ROUTER_BASE_URL || "http://localhost:20128";

/**
 * GET /.well-known/agent.json
 *
 * Returns the Dragon Router Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "Dragon Router AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 Dragon Router agent skills (22 API + 20 CLI) " +
