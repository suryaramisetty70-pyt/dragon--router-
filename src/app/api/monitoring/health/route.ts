...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@dragon-router/open-sse/services/rateLimitManager"),
      import("@dragon-router/open-sse/services/accountFallback"),
      import("@dragon-router/open-sse/services/requestDedup.ts"),
      import("@dragon-router/open-sse/services/quotaMonitor.ts"),
      import("@dragon-router/open-sse/services/sessionManager.ts"),
