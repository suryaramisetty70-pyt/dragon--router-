...
// Check if Dragon Router is configured as OpenAI-compatible provider
const hasDragonRouterConfig = (globalState: any) => {
  ...
  return (
    ...
    (baseUrl.includes("localhost") ||
      ...
      baseUrl.includes("dragon-router"))
  );
};
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasDragonRouter: hasDragonRouterConfig(globalState),
...
// POST - Configure Cline to use Dragon Router as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_dragon_router";
...
// DELETE - Remove Dragon Router OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "Dragon Router settings removed from Cline",
    });
  } catch (error) {
