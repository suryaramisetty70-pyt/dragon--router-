...
import { sanitizeErrorMessage, buildErrorBody } from "@dragon-router/open-sse/utils/error.ts";
 ...
 *
 * Dragon Router Copilot chat endpoint.
 * Accepts user messages about Dragon Router configuration and returns
