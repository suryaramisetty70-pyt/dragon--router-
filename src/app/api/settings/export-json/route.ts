 ...
 * Exports a legacy Dragon Router-compatible JSON backup.
 */
  ...
  try {
    ...
    const exportData: Record<string, unknown> = {
      ...
      _meta: {
        ...
        version: "dragon-router-v3-legacy-export",
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="dragon-router-legacy-backup-${new Date().toISOString().replace(/[:.]/g, "-")}.json"`,
      },
    });
  } catch (error) {
