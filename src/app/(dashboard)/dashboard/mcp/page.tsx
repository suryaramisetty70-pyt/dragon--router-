        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            >
              ...
              <li>
                {t.rich("mcpStep3", {
                  code1: (chunks) => <code className="text-xs">dragon_router_get_health</code>,
                  code2: (chunks) => <code className="text-xs">dragon_router_list_combos</code>,
                })}
              </li>
            </ol>
          </div>
