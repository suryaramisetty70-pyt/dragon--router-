...
test("#4055: the bootstrap spawn pins cwd to the package root so tsx + @/ aliases resolve", () => {
  ...
  assert.equal(spec.options.cwd, "/opt/homebrew/lib/node_modules/dragonrouter");
  ...
  assert.equal(spec.options.env.DRAGONROUTER_LIVE_WS_BOOTSTRAPPED, "1");
  assert.equal(spec.options.env.DRAGONROUTER_ENABLE_LIVE_WS, "0");
