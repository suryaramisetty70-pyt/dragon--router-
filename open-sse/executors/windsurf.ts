 ...
 *
 * DragonRouter → Windsurf model-ID mapping lives in MODEL_ID_MAP below.
 */
...
//
// This table handles only DragonRouter-style backwards-compat aliases where users
...
// DragonRouter uses dot-notation user IDs (e.g. "gpt-5.5-high").
