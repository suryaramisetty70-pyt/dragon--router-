...
export const SKIP_UNIVERSAL_HANDOFF_FLAG = "_dragon_routerSkipUniversalHandoff";
...
async function generateHandoffAsync(options: {
  ...
  const summaryBody = {
    ...
    temperature: 0.1,
    _dragon_routerSkipContextRelay: true,
    _dragon_routerInternalRequest: "context-handoff",
  };
...
async function generateUniversalHandoffAsync(options: {
  ...
  const summaryBody: Record<string, unknown> = {
    ...
    temperature: 0.1,
    _dragon_routerSkipContextRelay: true,
    _dragon_routerInternalRequest: "universal-handoff",
  };
