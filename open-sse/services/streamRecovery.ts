 ...
 * DragonRouter keeps the holdback OFF by default (see ResilienceSettings.streamRecovery)
...
// Terminal SSE markers DragonRouter emits across formats: OpenAI `data: [DONE]`,
