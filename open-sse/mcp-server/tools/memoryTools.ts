...
export const memoryTools = {
  dragon_router_memory_search: {
    name: "dragon_router_memory_search",
  ...
  dragon_router_memory_add: {
    name: "dragon_router_memory_add",
  ...
  dragon_router_memory_clear: {
    name: "dragon_router_memory_clear",
