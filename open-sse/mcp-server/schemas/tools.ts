/**
 * MCP Tool Schemas — Contracts for all 23 core and advanced Dragon Router MCP tools.
 *
 ...
 *
 * Each tool wraps existing Dragon Router API endpoints and exposes them through
...
// --- Tool 1: dragon_router_get_health ---
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "dragon_router_get_health",
  description:
    "Returns the current health status of Dragon Router including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 2: dragon_router_list_combos ---
...
export const listCombosTool: McpToolDefinition<typeof listCombosInput, typeof listCombosOutput> = {
  name: "dragon_router_list_combos",
  description:
...
// --- Tool 3: dragon_router_get_combo_metrics ---
...
> = {
  name: "dragon_router_get_combo_metrics",
  description:
...
// --- Tool 4: dragon_router_switch_combo ---
...
export const switchComboTool: McpToolDefinition<typeof switchComboInput, typeof switchComboOutput> =
  {
    name: "dragon_router_switch_combo",
    description:
...
// --- Tool 5: dragon_router_check_quota ---
...
// --- Tool 6: dragon_router_route_request ---
...
> = {
  ...
  description:
    "Sends a chat completion request through Dragon Router's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 7: dragon_router_cost_report ---
...
// --- Tool 8: dragon_router_list_models_catalog ---
...
> = {
  name: "dragon_router_list_models_catalog",
  description:
...
// --- Tool 9: dragon_router_web_search ---
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  ...
  description:
    "Performs a web search using Dragon Router's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
// --- Tool 10: dragon_router_web_fetch ---
...
// --- Tool 9: dragon_router_simulate_route ---
...
// --- Tool 10: dragon_router_set_budget_guard ---
...
> = {
  name: "dragon_router_set_budget_guard",
  description:
...
// --- Tool 11: dragon_router_set_routing_strategy ---
...
> = {
  name: "dragon_router_set_routing_strategy",
  description:
...
// --- Tool 12: dragon_router_set_resilience_profile ---
...
> = {
  name: "dragon_router_set_resilience_profile",
  description:
...
// --- Tool 13: dragon_router_test_combo ---
...
// --- Tool 14: dragon_router_get_provider_metrics ---
...
> = {
  name: "dragon_router_get_provider_metrics",
  description:
...
// --- Tool 15: dragon_router_best_combo_for_task ---
...
> = {
  name: "dragon_router_best_combo_for_task",
  description:
...
// --- Tool 16: dragon_router_explain_route ---
...
// --- Tool 17: dragon_router_get_session_snapshot ---
...
> = {
  name: "dragon_router_get_session_snapshot",
  description:
...
// --- Tool 18: dragon_router_db_health_check ---
...
> = {
  ...
  description:
    "Diagnoses Dragon Router database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
// --- Tool 19: dragon_router_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "dragon_router_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into Dragon Router. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
export const cacheStatsTool: McpToolDefinition<typeof cacheStatsInput, typeof cacheStatsOutput> = {
  name: "dragon_router_cache_stats",
  description:
...
export const cacheFlushTool: McpToolDefinition<typeof cacheFlushInput, typeof cacheFlushOutput> = {
  name: "dragon_router_cache_flush",
  description:
...
> = {
  name: "dragon_router_oneproxy_fetch",
  description:
...
> = {
  name: "dragon_router_oneproxy_rotate",
  description:
...
> = {
  name: "dragon_router_oneproxy_stats",
  description:
...
// --- dragon_router_agent_skills_get ---
...
> = {
  name: "dragon_router_agent_skills_get",
  description:
...
// --- dragon_router_agent_skills_coverage ---
...
> = {
  name: "dragon_router_agent_skills_coverage",
  description:
