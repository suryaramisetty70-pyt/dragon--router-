...
// local `droid` CLI. DragonRouter already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through DragonRouter.
//
...
// back to stored CLI credentials only when omitted. DragonRouter does NOT read
